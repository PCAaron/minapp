...
Page({
  ...
  loadMuiscDetail() {
    ...
    if(music && music.id == app.getPlayMusicId()){
      this.setData({
        isSame: true
      })
    } else {
    ...
    wx.cloud.callFunction({
      ...
      if(!this.data.isSame){
        backgroundAudioManager.src = this.data.detail.url
        backgroundAudioManager.title = this.data.detail.title
        backgroundAudioManager.singer = this.data.detail.author
        backgroundAudioManager.coverImgUrl = this.data.detail.pic
